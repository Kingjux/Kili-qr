<h1 align="center"> WEB BASED MULTIDEVICE QR </h1>
  ...
  <html>
   <body>
  <p align="center">  
  <a aria-label="FORK" href="https://github.com/Kingjux/kili-qr/fork" target="_blank">
    <img alt="License: GPL-3" src="https://img.shields.io/github/stars/kingjux/kili-qr?style=social" target="_blank" />
  </a>
  <a aria-label="Kilimanjaro_Md is free to use" href="https://youtube.com/@JASTINMTEWA_vn9pl" target="_blank">
...
## Deployment Methods
---
1.  ***Click [`FORK`](https://github.com/Kingjux/kili-qr/fork) and `Star ⭐ Repository` if you get help from repo.***
2.  ***Deploy on [`HEROKU`](https://dashboard.heroku.com/new?template=https://github.com/Kingjux/kili-qr).***
3.  ***Deploy on [`REPLIT`](https://replit.com/github/Kingjux/kili-qr).***
